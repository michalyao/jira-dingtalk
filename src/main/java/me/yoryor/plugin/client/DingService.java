...
public interface DingService {
     ...
     * @return
     */
    Future<String> corpOaMsgTo(String token, String agentId, String[] userId,
     ...
     * @return
     */
    Future<String> corpTextMsgTo(String token, String agentId, String[] userId, String[] partyId, String content);
